"""v5.1 — same as v5 but filters out dataset_0831 rows with Chinese descriptions.

Hypothesis: BGE multilingual handles cross-language matching imperfectly. If we
keep only English Done rows for direct prediction, the remaining ones might
match the ground truth better. Hashes whose dataset_0831 rows are all Chinese
fall back to the C4/Sherlock lookup pipeline.
"""
import csv
import json
import os
...
OUT = "outputs/submission_c4_v5_1.csv"
