...
OUT = "outputs/submission_c4_v6.csv"
...
EXTRA_TEST_MAPPINGS = {
    ...
    # New in v6: both fingerprinted to 2024-05-loop via dataset_v0/repos/ content-hash match
    # (64 unique-content .sol files vs <14 for any other audit). The two hashes are
    # 99.4% identical to each other — same audit submitted twice in the test set.
    "27c6f2a68058": ("2024-05-loop", "c4"),
    "c2426a2ab283": ("2024-05-loop", "c4"),
}
