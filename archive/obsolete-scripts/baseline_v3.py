...
DEFAULT_TAG_DIVERSITY_BONUS = 0.0
DEFAULT_REPEAT_TAG_PENALTY = 0.0
...
def parse_args():
    ...
    parser.add_argument("--output", default="outputs/submission_v3.csv")
...
def main():
    ...
    print("Baseline v3 submission generated successfully.")
